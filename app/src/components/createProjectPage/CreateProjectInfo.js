			...
			<div style={this.styles.container}>
				<div>
	            	...
	            	<div className={"GreenBox"}>
	            		...
	            		<h3 style={{textAlign: "left", marginLeft: "40px"}}>Looking For</h3>
	            		<LookingFor lookingFor = {this.props.values.lookingFor} handleInputChange={this.props.handleInputChange}/>
	            		//Here should be a submit button 
        			</div>
        		</div>
        	</div>
        )
